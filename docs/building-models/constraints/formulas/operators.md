...
- Negation: [`not (!)`](#not-alt)
- Conjunction: [`and (&&)`](#and-alt)
- Disjunction: [`or (||)`](#or-alt)
- Implication: [`implies (=>)`](#implies-alt)
  - If-then-else: [`else`](#implies-else-alt-else)
- If-and-only-if: [`iff (<=>)`](#iff-alt)
