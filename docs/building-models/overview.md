...
In Forge, we use [`sig`s](./sigs/sigs.md) to define the types that exist in a system, and [constraints](./constraints/constraints.md) to define the "rules" of the system.
