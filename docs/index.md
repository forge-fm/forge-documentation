...
!!! warning "This documentation is for Forge version 5." 
    This is the documentation page for Forge version 5. The documentation for [Forge v4.2](https://forge-fm.github.io/forge-documentation/4.2/) is preserved for those who wish to use it.
...
!!! note "If there are three languages, are there three versions of the documentation?"
...
Forge also has a [draft textbook](https://forge-fm.github.io/book/), which is in a different document in order to make searching easier.

## Using this Documentation

!!! hint "Navigation, Theme, and Search"
