...
!!! warning "Changes vs. February 2023"
...
!!! warning "Watch out: don't use types in your script code!"
...
!!! warning "Don't add child objects to the stage"
...
!!! warning "Edges do not render the objects they reference"
